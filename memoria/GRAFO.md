...
N58 ≡ [**NO ES TEOREMA**: el regreso solo diverge si se exige la MISMA ε en cada nivel; una comparación binaria no lo exige. Asume lo que quiere probar] REGRESO DE LA ESTACIONARIEDAD: certificar T* con precisión relativa ε exige observar k=1/ε² regímenes, o sea T ≥ T*/ε² (±20% ⇒ 25·T*; con T*=50a son 1.250 años), y ese presupuesto mayor exige otro 25× mayor. **La sucesión T_{k+1}=T_k/ε² no tiene punto fijo finito.** Estrictamente más fuerte que N33: allí la cota se vuelve verificable una vez superada; aquí **NUNCA es verificable**   [C04·E2] w=.30
