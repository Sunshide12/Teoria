...
N45 ≡ **«H≫τ» ES VACÍO, NO LEJANO**: agregar a cualquier escala deja el punto fijo ρ₁*=2^(2d)−1>0 para todo d>0 (verificado idéntico a 1d, 21d, 252d y 1260d; el AR(1) en cambio colapsa 0,953→0,045). **Ninguna escala vuelve iid la volatilidad.** Horizonte para CV(IV_H)=0,1: 8 años con d=0, 1.220 con d=0,26, **8·10⁸ con d=0,40**   [C03·D1] w=.88
